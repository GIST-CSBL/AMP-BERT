...
The fine-tuned AMP-BERT model can be reproduced and implemented for the AMP prediction downstream task in this [Colab notebook](https://drive.google.com/file/d/1BhutpkFDOM-72IinTAvdSHoJNRVDUySB/view?usp=sharing).
